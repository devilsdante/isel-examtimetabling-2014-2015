...
}
{
	...
	-ExaminationNormalAssignment(exam : Examination)\\
	-ExaminationForcingAssignment(exam : Examination)\\
	-UnassignExaminationsAndCoincidences(exams : List<int>)\\
	-UnassignExamination(exam : Examination)\\
	-UnassignExaminationAndCoincidences(exam : Examination)\\
	-UnassignExaminations(exams : List<int>)\\
	-AssignExamination(period : Period, room : Room, \\ exam : Examination)
}
\end{umlpackage}
\begin{umlpackage}[x = 2, y = 0]{Tools Layer} 
