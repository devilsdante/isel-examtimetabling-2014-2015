...
The GANTT diagram presented below shows a detailed planning for the development of all the main topics of this project until the end of the year including both phases mentioned above.

GANTT

The planning shown on the GANTT diagram may not be accurate. Some topics and features may take less time or may take longer than specified. The developing order or certain features may change depending on the necessity of these to implement others already in development.
