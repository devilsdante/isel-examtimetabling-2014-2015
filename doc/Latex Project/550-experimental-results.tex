...
\multicolumn{1}{c}{Set} & \multicolumn{1}{c}{Current} &	\multicolumn{1}{c}{Previous}\\
\multicolumn{1}{c}{}	& \multicolumn{1}{c}{approach} & \multicolumn{1}{c}{approach}\\
...
\begin{table*}[!t]
\centering
\caption{Comparison of the proposed approach with the ITC 2007 finalists. The comparison is made between the average values of each approach. The best solutions are indicated in bold. ''--'' indicates that a feasible solution could not be obtained.}
\sisetup{table-alignment=center,detect-weight=true,detect-inline-weight=math}
\begin{tabular}{%
	S[table-figures-integer=3]%
	S[table-format=5.1]%
