...
namespace Tools.Neighborhood.Timetable
{
    public class PeriodSwapNeighbor : INeighbor
    {
        ...
        public readonly int examination1_id;
        public readonly int examination2_id;
        public readonly int period1_id;
        public readonly int period2_id;
        public readonly int room1_id;
        public readonly int room2_id;
        ...
        public Solution Accept()
        {
            ...
            solution.SetExam(period2_id, room1_id, examination1_id);
            solution.SetExam(period1_id, room2_id, examination2_id);
        ...
        {
            solution.UnsetExam(period2_id, room1_id, examination1_id);
            solution.UnsetExam(period1_id, room2_id, examination2_id);
